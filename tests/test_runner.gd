...
const TESTS := [
	...
	preload("res://tests/unit/test_hud_menu_builders.gd"),
	preload("res://tests/unit/test_hud_feature_components.gd"),
	...
	preload("res://tests/unit/test_status_toast_sfx.gd"),
	...
	preload("res://tests/unit/test_drop_evaluator.gd"),
	...
	preload("res://tests/unit/test_cheat_start_runtime.gd"),
	...
	preload("res://tests/unit/test_main_consumable_lifecycle.gd"),
	preload("res://tests/unit/test_crafting_service.gd"),
	preload("res://tests/unit/test_facility_crafting_runtime.gd"),
	preload("res://tests/unit/test_facility_sleep_runtime.gd"),
	preload("res://tests/unit/test_trade_service.gd"),
	preload("res://tests/unit/test_narrative_runtime.gd"),
	preload("res://tests/unit/test_run_start_event_selector.gd"),
	...
	preload("res://tests/unit/test_dungeon_generation_contract.gd"),
	...
	preload("res://tests/unit/test_repair_interaction_service.gd"),
	preload("res://tests/unit/test_ruin_loot_service.gd"),
	preload("res://tests/unit/test_repair_target_world_generation.gd"),
	preload("res://tests/unit/test_dev76_mining_stone_runtime.gd"),
	preload("res://tests/unit/test_dev_136_resource_acquisition.gd"),
	...
	preload("res://tests/unit/test_pointer_combat_input.gd"),
