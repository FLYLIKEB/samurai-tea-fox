...
func run(asserts) -> void:
	...
	var spinner := scene_root.get_node_or_null("LoadingOverlay/LoadingStatusPanel/LoadingStatusRow/LoadingSpinner") as Label
	...
	asserts.equal(label, scene_root.get_node_or_null("LoadingOverlay/LoadingStatusPanel/LoadingStatusRow/LoadingStatus"), "loading status remains available above the backdrop")
