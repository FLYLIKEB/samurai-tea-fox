...
class ContentImageAuditTests(unittest.TestCase):
    def test_all_item_and_monster_rows_resolve_to_runtime_assets(self):
        ...
        self.assertEqual(payload["audit"]["dedicated_asset_missing"], 1)
        self.assertEqual(payload["audit"]["art_review_required"], 43)
        ...
        self.assertEqual(payload["audit"]["by_resolution"]["kind_fallback_exception"], 1)
        ...
        self.assertEqual(items["stone_pickaxe"]["resolution"], "kind_fallback_exception")
        self.assertEqual(items["stone_pickaxe"]["asset_id"], "asset_assets_ui_icons_atlas_low_table_png")
        self.assertFalse(items["stone_pickaxe"]["runtime_approved"])
        self.assertTrue(items["stone_pickaxe"]["dedicated_asset_missing"])
        self.assertEqual(
