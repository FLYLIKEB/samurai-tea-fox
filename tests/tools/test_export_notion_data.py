...
class ExportedNotionDataTests(unittest.TestCase):
    ...
    def test_newly_exported_canonical_rows_are_present(self):
        ...
        self.assertEqual(items["wood"]["interaction_definition"]["rules"][0], {"action": "chop", "node_kind": "tree", "required_tool_item_id": "stone_axe"})
        self.assertEqual(items["item_5"]["interaction_definition"]["rules"][0], {"action": "chop", "node_kind": "tree", "required_tool_item_id": "stone_axe"})
        self.assertEqual(items["item_28"]["interaction_definition"]["rules"][0], {"action": "mine", "node_kind": "ore_vein", "required_tool_item_id": "stone_pickaxe"})
