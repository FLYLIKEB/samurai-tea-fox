...
const FacilityPreviewPresenter = preload("res://src/presentation/facility_preview_presenter.gd")
...
const DungeonDefinitionResolver = preload("res://src/dungeon/dungeon_definition_resolver.gd")
...
const NarrativeSession = preload("res://src/narrative/narrative_session.gd")
