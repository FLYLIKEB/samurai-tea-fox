...
static func hud_status_style() -> StyleBoxTexture:
	return _texture_style(HUD_STATUS_TEXTURE, Vector4.ZERO, Vector4(26, 23, 12, 10))
...
static func hud_bottom_nav_style() -> StyleBoxTexture:
	return _texture_style(HUD_BOTTOM_NAV_TEXTURE, Vector4(0, 25, 0, 21), Vector4(38, 25, 42, 21))
