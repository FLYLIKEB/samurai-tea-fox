...
const RENDER_FOREST := "terrain_forest_boundary_tree_tileset"
...
const RENDER_MOUNTAIN_CONIFER := "asset_assets_sprites_objects_natural_props_pine_tree_small_32x32_png"
...
const RENDER_WASTELAND_DEAD_TREE := "asset_assets_sprites_objects_natural_props_dead_tree_small_32x32_png"
...
const RENDER_SNOWFIELD_PINE := "asset_assets_tiles_terrain_snow_snowy_pine_tree_01_32x32_png"
...
const RENDER_RAINFOREST_JUNGLE := "asset_assets_sprites_objects_natural_props_dense_shrub_32x32_png"
...
const RENDER_RAINFOREST_VINE_PATH := "asset_assets_sprites_objects_natural_props_bamboo_reeds_32x32_png"
const RENDER_RAINFOREST_TEA_FIELD := "asset_assets_sprites_objects_crafting_tea_leaf_worktable_32x32_png"
const RENDER_RAINFOREST_AGARWOOD := "asset_assets_sprites_objects_natural_props_round_tree_large_32x32_png"
