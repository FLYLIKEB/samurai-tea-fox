...
const RENDER_MOUNTAIN_SLOPE := "asset_assets_tiles_terrain_mountain_mountain_slope_01_32x32_png"
const RENDER_MOUNTAIN_PATH := "asset_assets_tiles_terrain_mountain_mountain_path_01_32x32_png"
